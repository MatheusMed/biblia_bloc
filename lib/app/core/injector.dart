...
import 'package:biblia_bloc/app/domain/usecases/implementations/get_all_books_usecases_imp.dart';
...
import '../data/datasource/offline/get_all_books_datasource_offline.dart';
import '../data/datasource/offline/get_all_books_offline.dart';
...
class Injector {
  static void init() {
    ...
    injector.registerFactory<IHiveStorage>(() => HiveStorage());
  }
}
